...
void handle_request(int client_fd) {
    ...
    int headerpipe[2]; // fd HEADERS_FD: headers
    int stdinpipe[2];
    ...
    if (pid == 0) {
        ...
        dup2(headerpipe[1], HEADERS_FD);  // fd HEADERS_FD for headers
    ...
    write(client_fd, headers, headers_len);  // headers (including blank line) from fd HEADERS_FD
